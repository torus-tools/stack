...
exports.script = function cloudFrontDist(domain) {
    ...
    if(!digicert) {
        console.log('Error. Please create a digital certificate before creating a distribution.');
    }
    else {
        var params = {
            DistributionConfig: {
        ...
        cloudfront.createDistribution(params, function(err, data) {
            if (err) {
                ...
                console.log('Please wait untill the distribution has Deployed status . . .')
